# RFC 0033 — Cognitive pipeline Security & Threat Model, Status: Draft, Author: Open CoT Community, Created: 2026-04-14
...
| Harness | Verified identity ([RFC 0026](0026-requester-identity-auth.md)), trace binding, schema validation, FSM transitions ([RFC 0007](0007-cognitive-pipeline-protocol.md)). | Raw model JSON without normalization and size limits. |
...
```json
{
  "threat_catalog": {
    "schema_version": "0.1",
    "catalog_id": "tc_acme_pipelines_core_2026q2",
    "title": "ACME governed pipelines — baseline threats",
    "entries": [
      {
