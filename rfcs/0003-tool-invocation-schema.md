...
- Cognitive pipeline frameworks rely on structured tool calls.
- Coding pipelines require deterministic tool invocation formats.
...
- **Extensible** for future cognitive pipeline frameworks.

### 3.2 Non‑Goals
- Defining tool semantics.
- Defining a universal tool registry.
- Enforcing a specific cognitive pipeline.
...
This mirrors ReAct and modern cognitive pipeline frameworks.
...
At least one cognitive pipeline emits this schema.
