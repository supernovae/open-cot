...
| Field | Role |
|-------|------|
| `manifest_id` | Stable id for this manifest revision (≠ `requester_id`). |
...
| `dependencies[]` | Pipelines, datasets, tool packs, models. |
...
```json
{
  ...
  "title": "Open CoT RFC 0032 — Cognitive pipeline Deployment Manifest",
  "type": "object",
  ...
  "$defs": {
    ...
    "dependency": {
      ...
      "properties": {
        ...
        "kind": { "type": "string", "enum": ["pipeline", "dataset", "tool_pack", "model", "other"] },
    ...
    "deployment_manifest": {
      ...
      "required": ["schema_version", "manifest_id", "requester_id", "version", "runtime", "policies", "governance_ref", "sandbox_config", "budget_defaults", "tool_allowlist", "scaling"]
    }
  },
...
**Code-assistant cognitive pipeline** — strict sandbox, org governance, hard budget, repo tools, GPU for embeddings.
...
```json
{
  "deployment_manifest": {
    ...
    "requester_id": "cognitive-pipeline:org/acme/code-assistant",
    "version": "2.4.1",
    "runtime": {
      "container_image": "registry.acme.example/pipelines/code-assistant:2.4.1",
      "entrypoint": ["/opt/opencot/bin/opencotd", "--config", "/etc/opencot/cognitive-pipeline.yaml"],
    ...
    "governance_ref": "gov://acme/prod/eu-west/code_pipelines",
    "sandbox_config": {
    ...
    "metadata": { "team": "platform-pipelines", "region": "eu-west-1" }
  }
}
```
...
[RFC 0007](0007-cognitive-pipeline-protocol.md) · [RFC 0017](0017-runtime-safety-sandboxing.md) · [RFC 0038](0038-cost-aware-reasoning-budget.md) · [RFC 0041](0041-policy-enforcement-schema.md) · [RFC 0044](0044-governance-organizational-controls.md)
