# RFC 0022 — Cognitive pipeline Evaluation Protocol (v0.1)
**Status:** Draft  
**Author:** Byron / Open CoT Community  
**Created:** 2026-04-14  
**Target Version:** Schema v0.4  
**Discussion:** https://github.com/supernovae/open-cot/discussions/22
---
...
```json
{
  ...
  "title": "Open CoT RFC 0022 — Cognitive pipeline Evaluation Protocol",
  "type": "object",
  "properties": {
