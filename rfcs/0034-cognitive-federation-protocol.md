# RFC 0034 — Cognitive pipeline Federation Protocol, Status: Draft, Author: Open CoT Community, Created: 2026-04-14
...
**Vs. [RFC 0027](0027-distributed-execution-protocol.md):** 0027 is routing/topology; this RFC is the cross-admin trust and delegation envelope (orthogonal transport headers).
...
```json
{
  ...
  "title": "Open CoT RFC 0034 — Cognitive pipeline Federation Protocol",
  "type": "object",
...
```json
{
  "federation_request": {
    ...
    "delegation_request": {
      ...
      "requester": "cognitive-pipeline:org/lab/planner-alpha",
...
[RFC 0026](0026-requester-identity-auth.md) · [RFC 0027](0027-distributed-execution-protocol.md) · [RFC 0047](0047-delegation-extension.md) · [RFC 0048](0048-execution-receipts-audit-envelopes.md)
