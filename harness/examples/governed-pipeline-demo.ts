#!/usr/bin/env npx tsx
/**
 * Governed cognitive pipeline demo — run with `npx tsx examples/governed-pipeline-demo.ts`
 *
 ...
 *   npx tsx examples/governed-pipeline-demo.ts                           # search (allowed)
 *   npx tsx examples/governed-pipeline-demo.ts "calculate 2+2"           # calculator (allowed)
 *   npx tsx examples/governed-pipeline-demo.ts "search for open source"  # search (allowed)
 *   npx tsx examples/governed-pipeline-demo.ts --deny "search for info"  # search (denied by policy)
 *
